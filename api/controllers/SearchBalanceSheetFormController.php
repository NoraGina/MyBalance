<?php
class SearchBalanceSheetFormController extends AppController
{
    ...
    public function init()
    {
        ...
        {
            $data['title']="Search balance sheet";
            ...
            $data['mainContent'] = $this->render(APP_PATH.VIEWS.'searchBalanceSheetFormView.html', $data);
